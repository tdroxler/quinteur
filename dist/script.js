...
class NoteReadingGame {
    ...
    generateQuestion() {
        const clef = Math.random() > 0.5 ? 'G' : 'F';
        ...
        if (clef === 'G') {
            ...
            positions.push({ note: 'C', octave: 4, yPosition: -6 }, // C4 (ledger line below)
            ...
            positions.push({ note: 'E', octave: 2, yPosition: -6 }, // E2 (ledger line below)
